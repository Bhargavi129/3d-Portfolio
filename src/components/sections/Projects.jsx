...
import { projects } from "../../data/constants"; // Make sure the path is correct
import ProjectCard from "../cards/ProjectCard";

const Container = styled.div`
  display: flex;
  flex-direction: column;
  justify-content: center; /* Fixed typo: justify-contnet to justify-content */
  margin-top: 50px;
  padding: 0px 16px;
  position: relative; /* Fixed typo: rlative to relative */
  z-index: 1;
  align-items: center;
`;
...
const ToggleButtonGroup = styled.div`
  ...
  font-size: 16px;
  border-radius: 12px;
  font-weight: 500; /* Fixed typo: font-weight 500 to font-weight: 500; */
  margin: 22px 0;
  @media (max-width: 768px) {
    font-size: 12px;
  }
